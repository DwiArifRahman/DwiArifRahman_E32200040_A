            ...
            <table class="table align-items-center table-flush" id="data">
              ...
              <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="<?= url('image', $t->bukti) ?>">Lihat</a>
                    </td>
                    ...
                    <td>
                        @if ($t->status == 1)
                                              <button class="btn btn-primary" data-toggle="modal" data-target="#edit<?= $t->id ?>">Edit</button>
          ...
          <div class="modal-body">
            <form action="<?= route('transaksi.update', $r->id) ?>" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" name="user" value="<?= $r->user ?>" class="form-control" id="recipient-name">
              </div>
              <div class="form-group">
                <label class="col-form-label">Alamat</label>
              ...
              <div class="form-group">
                <label class="col-form-label">Bukti</label>
                <input type="text" name="bukti" value="<?= $r->bukti ?>" class="form-control" id="recipient-name">
              </div>
              <div class="form-group">
                <label class="col-form-label">Status</label>
              ...
              <div class="form-group">
                <label class="col-form-label">Jasa Pengiriman</label>
                <input type="text" name="jasa_pengiriman" value="<?= $r->jasa_pengiriman ?>" class="form-control" id="recipient-name">
              </div>
              <div class="form-group">
                <label class="col-form-label">No Resi</label>
...
<div class="modal fade" id="addKurir<?= $t->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="hapus<?= $r->id ?>" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Hapus data transaksi : <?= $r->no_transaksi?></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="<?= route('transaksi.destroy', $r->id) ?>" method="POST">
              @method('DELETE')
              @csrf
